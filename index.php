...
<head>
    ...
    <meta name="author" content="ANDRIMANANTENA Tolojanahary">
   
    <title>Gasy Event</title>
    <!-- font icons -->
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">                     
                    <li class="nav-item">
                        <a class="nav-link" href="#service">Acceuil</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="inscription.php" class="ml-4 nav-link btn btn-primary btn-sm rounded">Inscription</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <header class="header">
        <div class="overlay">
            <h1 class="subtitle">bienvenu </h1>
            <h1 class="title"> gasy event</h1>  
        </div>  
        <div class="shape">
    ...
    <section  id="service" class="section pt-0">
        <div class="container">
            <h6 class="section-title text-center">EVENEMENT DE LA SEMAINE</h6>
                ...
                <div class="col-md-4">
                    <div class="card mb-4 mb-md-0">
                        <div class="card-body">
                            ...
                            <img src="./assets/imgs/cabaret.jpg" alt="cabaret" width="300" height="200">
                            <h5 class="card-title mt-3"> CABARET DE HARILALA <h5>
                            <p class="mb-0">Le 13 janvier 2023</p>
                            <button class="btn btn-primary w-lg">en savoir plus</button>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card mb-4 mb-md-0">
                        <div class="card-body">
                            ...
                            <img src="./assets/imgs/automobile.jpg" alt="cabaret" width="300" height="200">
                            <h5 class="card-title mt-3"> SALON DE L'AUTOMOBILE </h5>
                            <p class="mb-0">Le 25 janvier 2023</p>
                            <button class="btn btn-primary w-lg">en savoir plus</button>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card mb-4 mb-md-0">
                        <div class="card-body">
                            ...
                            <img src="./assets/imgs/dance.jpg" alt="cabaret" width="300" height="200">
                            <h5 class="card-title mt-3">CONCOURS DE DANCE</h5>
                            <p class="mb-0">Le 15 Janvier 2023</p>
                            <button class="btn btn-primary w-lg">en savoir plus</button>
                        </div>
                    </div>
                </div>              
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-md-6 pr-md-5 mb-4 mb-md-0">
                    <h6 class="section-title mb-0">About Gasy Event</h6>
    ...
    <section class="section" id="blog">
        <div class="container">
            <h6 class="section-title mb-0 text-center">Derniers évènements</h6>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card border-0 mb-4">
                        ...
                        <div class="card-body">                         
                            <h6 class="card-title">Peintivale.</h6>
                            <p>Fuga quae ratione inventore Perferendis porro.</p>
                            <a href="javascript:void(0)" class="small text-muted">Voir plus</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card border-0 mb-4">
                        ...
                        <div class="card-body">                         
                            <h6 class="card-title"> Salon de l'architecte</h5>
                            <p>Fuga quae ratione inventore Perferendis porro.</p>
                            <a href="javascript:void(0)" class="small text-muted">Voir plus</a>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card border-0 mb-4">
                        ...
                        <div class="card-body">                         
                            <h6 class="card-title">Hackaton</h6>
                            <p>Fuga quae ratione inventore Perferendis porro.</p>
                            <a href="javascript:void(0)" class="small text-muted">Voir plus</a>
                        </div>
                    </div>
    ...
    <section class="section" id="testmonial">
        <div class="container">
            <h6 class="section-title text-center mb-0">Temoignage</h6>
            <h6 class="section-subtitle mb-5 text-center"> Ce que notre client a dit</h6>
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="media align-items-center mb-3">
                                ...
                                <div class="media-body">
                                    <h6 class="mt-1 mb-0">Joseph</h6>
                                    <small class="text-muted mb-0">Entrepreuneur</small>     
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="media align-items-center mb-3">
                                ...
                                <div class="media-body">
                                    <h6 class="mt-1 mb-0">Harilala</h6>
                                    <small class="text-muted mb-0">Mathématicienne</small>      
                                </div>
                            </div>
                            <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus enim modi, id dicta reiciendis itaque.</p>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="media align-items-center mb-3">
                                <img class="mr-3" src="assets/imgs/avatar-1.jpg" alt="">
                                <div class="media-body">
                                    <h6 class="mt-1 mb-0">Hery Nirina</h6>
                                    <small class="text-muted mb-0">Développeur</small>        
                                </div>
                            </div>
                            <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus enim modi, id dicta reiciendis itaque.</p>
                        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-5 my-3">
                    ...
                    <p class="mb-4">+261 34 62 271 00</p>

                    <h6 class="mb-0">Address</h6>
                    <p class="mb-4">Lot IB 394 Andoharanofotsy</p>

                    <h6 class="mb-0">Email</h6>
                    <p class="mb-0">tolotraadr@gmail.com</p>
                    <p></p>
                </div>
    ...
    <!-- js -->
    <script src="assets/js/tolojanahary.js"></script>
